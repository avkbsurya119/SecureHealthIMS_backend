...
async function run() {
    // Using the IP address from nslookup
    const dbUrl = 'postgres://postgres:dbProject42SafeX9@172.17.18.2:5432/postgres';
    ...
    try {
        console.log('Attempting to connect via IP 172.17.18.2...');
